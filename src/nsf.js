...
let header = nsfFormat.concat(version, totalSongs, startingSong,
  loadAdr, initAdr, playAdr)

export let nsfDriver = header.concat(songName, artist, copyright,
  ntscSpeed, banking, palSpeed, playMode, expansionAudio, prgLength, 0, 0, 0,
  load, init, silence, soundLoad, playFrame, fetchByte, doNoise, checkRest,
  setTempPorts, setApu, songHeaderAdr, noteTable, songHeader, square1,
  square2, tri, noise)
