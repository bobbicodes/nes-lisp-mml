...
const init = [0xA9, 0x0F, 0x8D, 0x15, 0x40, 0xA9, 0x00, 0x8D, 0x00, 0x02, 0xA9, 0xFF, 0x8D, 0x03, 0x02, 0x8D, 0x04, 0x02];
const silence = [0xA9, 0x30, 0x8D, 0x05, 0x02, 0x8D, 0x09, 0x02, 0x8D, 0x11, 0x02, 0xA9, 0x80, 0x8D, 0x0D, 0x02, 0x60, 0xA9, 0x00, 0x8D, 0x15, 0x40, 0xA9, 0x01, 0x8D, 0x00, 0x02, 0x60];
...
const doNoise = [
	...
	0xAD, 0x02, 0x02, 0x29, 0x10, 0xF0, 0x08, 0xAD, 0x02, 0x02, 0x09, 0x80, 0x8D, 0x02, 0x02, 0xAD, 0x02, 0x02, 0x9D, 0x39, 0x02, 0x60
];
...
const setTempPorts = [
	...
	0xBD, 0x21, 0x02, 0x0A, 0x0A, 0xA8, 0xBD, 0x33, 0x02, 0x99, 0x05, 0x02, 0xA9, 0x08, 0x99, 0x06, 0x02, 0xBD, 0x39, 0x02, 0x99, 0x07, 0x02, 0xBD, 0x3F, 0x02, 0x99, 0x08, 0x02, 0xBD, 0x1B, 0x02, 0x29, 0x02, 0xF0, 0x10, 0xBD, 0x21, 0x02, 0xC9, 0x02, 0xF0, 0x04, 0xA9, 0x30, 0xD0, 0x02, 0xA9, 0x80, 0x99, 0x05, 0x02, 0x60
];
...
header = header.concat(version, totalSongs, startingSong, loadAdr, initAdr, playAdr)

export let nsfDriver = header
nsfDriver = header.concat(load, init, silence, soundLoad, playFrame, fetchByte,
  doNoise, checkRest, setTempPorts, setApu, block1, block2, songHeader,
  square1, square2, tri, noise)

nsfDriver = header.concat(songName, artist, copyright, ntscSpeed, banking,
  palSpeed, playMode, expansionAudio, prgLength, 0, 0, 0, load, init, silence, soundLoad, playFrame, fetchByte, doNoise, checkRest, setTempPorts, setApu, block1, block2, songHeader, square1, square2,
   tri, noise)
