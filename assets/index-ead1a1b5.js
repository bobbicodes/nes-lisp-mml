...
(play (drum-seq [{:length 1 :time 0 :pitch 15}]))`,extensions:[basicSetup,clojure()]}),view=new EditorView({state:editorState,parent:document.querySelector("#app")});document.querySelector("#app").onclick=h=>updateDocBar(view);
